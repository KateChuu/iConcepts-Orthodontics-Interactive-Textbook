...
export default function Chapter4Page() {
  ...
  const sections = [
    { id: 1, title: 'Background and Classification', href: '/chapters/chapter4/intro', icon: 'https://res.cloudinary.com/difs4tswt/image/upload/v1745402176/Intro_ChatGPT_Image_ziurdw.png' },
