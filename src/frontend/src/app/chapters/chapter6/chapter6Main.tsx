...
export default function Chapter6Page() {
    ...
    const sections = [
        ...
        { id: 2, title: 'Video 1', href: '/chapters/chapter6/video1', icon: 'https://res.cloudinary.com/difs4tswt/image/upload/v1745114338/section2_qdnkex.png' },
        { id: 3, title: 'Video 2', href: '/chapters/chapter6/video2', icon: 'https://res.cloudinary.com/difs4tswt/image/upload/v1745114338/section3_vmgqen.png' },
        { id: 4, title: 'Video 3', href: '/chapters/chapter6/video3', icon: 'https://res.cloudinary.com/difs4tswt/image/upload/v1745114338/section4_c14ay8.png' },
    ];
