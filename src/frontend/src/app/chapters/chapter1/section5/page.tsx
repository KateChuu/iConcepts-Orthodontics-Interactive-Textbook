...
export default function Section5() {
    return (
        ...
        >
            ...
            <h3 className="text-lg font-semibold text-gray-600 mt-4">INCREASED PREVALENCE OF MALOCCLUSION</h3>
            <p>
            ...
            <h3 className="text-lg font-semibold text-gray-600 mt-4">DEMAND OF ORTHODONTIC TREATMENT</h3>
            <p>
            ...
            <h2 className="text-xl font-bold mt-6">CLASS I MALOCCLUSION</h2>
            ...
            <h3 className="text-lg font-semibold text-gray-600 mt-4">Crowding</h3>
            <p>
            ...
            <h3 className="text-lg font-semibold text-gray-600 mt-4">Spacing</h3>
            <p>
            ...
            <h3 className="text-lg font-semibold text-gray-600 mt-4">Bimaxillary Proclination</h3>
            <p>
            ...
            <h3 className="text-lg font-semibold text-gray-600 mt-4">Vertical Anomalies</h3>
            <p>
            ...
            <h3 className="text-lg font-semibold text-gray-600 mt-4">Etiology</h3>
            <p>It is broadly divided into:</p>
            ...
            <h3 className="text-lg font-semibold text-gray-600 mt-4">Environmental</h3>
            <p>
            ...
            <h3 className="text-lg font-semibold text-gray-600 mt-4">Classification</h3>
            <p>Anterior Open Bite (AOB) can be classified as:</p>
            <ul className="list-disc pl-5">
                <li>Skeletal</li>
                <li>Dental</li>
            </ul>

            <h3 className="text-lg font-semibold text-gray-600 mt-4">Clinical Features of Skeletal AOB</h3>
            <p>
            ...
            <h3 className="text-lg font-semibold text-gray-600 mt-4">Clinical Features of Dental AOB</h3>
            <p>
            ...
            <h3 className="text-lg font-semibold text-gray-600 mt-4">Transverse Anomalies</h3>
            <p>
            ...
            <p>
                <a href="https://prezi.com/dc8rk8kod4dj/examination-treatment-planning/?utm_campaign=share&utm_medium=copy" target="_blank" className="text-blue-600 underline">
