...
export default function VideoTab() {
    const videos = [
        ...
        {
            title: 'Video 7: Part 1DDS1 Growth & Development DrSND2023',
        ...
        {
            title: 'Video 8: Part 2 Growth and Development of Maxillary and Mandibular',
            description: 'Chapter 6',
        ...
        {
            title: 'Video 9: Part 3 Growth and Development of Maxillary and Mandibular',
            description: 'Chapter 6',
        ...
        {
            title: 'Video 10: EProf R Meithke Dec 2024 (1)',
        ...
        {
            title: 'Video 11: EProf R Meithke Dec 2024 (2)',
            description: 'Chapter 7',
        ...
        {
            title: 'Video 12: Fireside Discussion EPMiethke Dec 2024 2',
            description: 'Chapter 7',
